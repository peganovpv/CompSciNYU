...
public class MyArrayListClass<E> implements List<E> {
    // instance variables
    ...
    public MyArrayListClass() { this(CAPACITY); }   // constructs list with default capacity
  
    /** Creates an array list with given initial capacity. */
    @SuppressWarnings({"unchecked"})
    public MyArrayListClass(int capacity) {         // constructs list with given capacity
    ...
    private class ArrayIterator implements Iterator<E> {
      ...
      public void remove() throws IllegalStateException {
        ...
        MyArrayListClass.this.remove(j-1);  // that was the last one returned
    ...
    // Switch - switch the first and last elements of the list -  so a list of A,B,C,D,E becomes E,B,C,D,A.
    ...
    //  Swap - receives 2 unequal indexes and switches them so if the list is A,B,C,D,E then swap(2,5) gives a list of A,E,C,D,B.
